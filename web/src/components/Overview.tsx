...
export const ICONS: Record<string, React.ReactNode> = {
  ...
  /* same geometry as the Calendar bottom-nav tab icon — keep in sync */
  cal60: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#2E7CF7" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" opacity=".85"><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M8 2v4M16 2v4M3 10h18" /><circle cx="12" cy="15" r="1.6" fill="#2E7CF7" stroke="none" /></svg>,
  pace: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" opacity=".85"><rect x="4" y="12" width="2.6" height="8" rx="1.3" stroke="#2E7CF7" strokeWidth="1.1" /><rect x="9.2" y="4" width="2.6" height="16" rx="1.3" fill="#2E7CF7" /><rect x="14.4" y="14" width="2.6" height="6" rx="1.3" stroke="#2E7CF7" strokeWidth="1.1" /><rect x="19.6" y="9" width="2.6" height="11" rx="1.3" fill="#2E7CF7" /></svg>,
  ...
  pulse: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M3 16h3l2.4-5 3.2 8 2.4-5H21" stroke="#2E7CF7" strokeWidth="2.2" /><path d="M12 2v2.4M5 4.6l1.6 1.6M19 4.6l-1.6 1.6" stroke="#38E1F0" strokeWidth="1.8" opacity=".85" /></svg>,
